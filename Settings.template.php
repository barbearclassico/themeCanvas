...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array('id' => 'theme_seo','type'=>'tab','label'=>$txt['dhayzon_theme_seo']),

		array(
			'id' => 'header_title_pague',
			'label' => $txt['header_title_pague'],
			'description' => $txt['header_title_pague_desc'],
			'type' => 'text',
		),
		array(
			'id' => 'site_slogan',
		...
		array('id' => 'theme_colors','type'=>'tab','label'=>$txt['dhayzon_theme_color'] ),

		array(
			'id' => 'dhayzon_menu_bg',
			'label' => $txt['dhayzon_menu_bg_lb'],
			'description' => $txt['dhayzon_menu_bg_desc'],
			'type' => 'text',
			'size' => 8,
		),
		array(
			'id' => 'dhayzon_color_link',
			'label' => $txt['dhayzon_color_link_lb'],
			'description' => $txt['dhayzon_color_link_desc'],
			'type' => 'text',
			'size' => 8,
		),
		array(
			'id' => 'dhayzon_header_bg',
			'label' => $txt['dhayzon_header_bg_lb'],
			'description' => $txt['dhayzon_header_bg_desc'],
			'type' => 'text',
			'size' => 8,
		),
		array(
			'id' => 'dhayzon_news_bg',
			'label' => $txt['dhayzon_news_bg_lb'],
			'description' => $txt['dhayzon_news_bg_desc'],
			'type' => 'text',
			'size' => 8,
		),
		array(
			'id' => 'dhayzon_img_bg',
			'label' => $txt['dhayzon_img_bg_lb'],
			'description' => $txt['dhayzon_img_bg_desc'],
			'type' => 'text',
 		),
		array(
			'id' => 'dhayzon_forumwidht',
			'label' => $txt['dhayzon_forumwidth_lb'],
			'description' => $txt['dhayzon_forumwidth_desc'],
 			'type' => 'text',
 			'size' => 8,
 		),
		'',
      array('id' => 'theme_advertising_option','type'=>'tab','label'=>$txt['dhayzon_theme_advertising'] ),
        
		array(
			'id' => 'dhayzon_ads_display',
			'label' => $txt['dhayzon_ads_display'],
			'description' => $txt['dhayzon_ads_display_des'],
 			'type' => 'textarea',
 			'size' => 8,
 		),
		array(
			'id' => 'dhayzon_ads_indexFooter',
			'label' => $txt['dhayzon_ads_indexFooter'],
			'description' => $txt['dhayzon_ads_indexFooter_des'],
 			'type' => 'textarea',
 			'size' => 8,
 		),
		array(
			'id' => 'dhayzon_ads_messageTop',
			'label' => $txt['dhayzon_ads_messageTop'],
			'description' => $txt['dhayzon_ads_indexFooter_des'],
 			'type' => 'textarea',
 			'size' => 8,
 		),
		array(
			'id' => 'dhayzon_ads_indexTop',
			'label' => $txt['dhayzon_ads_indexTop'],
			'description' => $txt['dhayzon_ads_indexTop_des'],
 			'type' => 'textarea',
 			'size' => 8,
 		),
		'',
        array('id' => 'theme_general_option','type'=>'tab','label'=>$txt['dhayzon_theme_option'] ),
